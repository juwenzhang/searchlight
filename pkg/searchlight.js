/* @ts-self-types="./searchlight.d.ts" */
...
export class SearchEngine {
    ...
    batchSearch(queries, options) {
        const ret = wasm.searchengine_batchSearch(this.__wbg_ptr, queries, options);
        if (ret[2]) {
    ...
    clear() {
        wasm.searchengine_clear(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
    docCount() {
        const ret = wasm.searchengine_docCount(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @param {number} doc_id
     ...
     */
    getDocument(doc_id) {
        const ret = wasm.searchengine_getDocument(this.__wbg_ptr, doc_id);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    index(text) {
        ...
        const ret = wasm.searchengine_index(this.__wbg_ptr, ptr0, len0);
        return ret >>> 0;
    }
    /**
     * @param {any} documents
    ...
    indexBatch(documents) {
        const ret = wasm.searchengine_indexBatch(this.__wbg_ptr, documents);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    constructor() {
        const ret = wasm.searchengine_new();
        this.__wbg_ptr = ret;
     ...
     */
    remove(doc_id) {
        const ret = wasm.searchengine_remove(this.__wbg_ptr, doc_id);
        return ret !== 0;
    }
    /**
     * @param {string} query
     ...
     * @returns {any}
     */
    searchFuzzy(query, max_distance) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_searchFuzzy(this.__wbg_ptr, ptr0, len0, max_distance);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    searchPhrase(phrase) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_searchPhrase(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    searchPinyin(query) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_searchPinyin(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    searchWithOptions(query, options) {
        const ptr0 = passStringToWasm0(query, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_searchWithOptions(this.__wbg_ptr, ptr0, len0, options);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    suggest(prefix) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_suggest(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @returns {any}
     */
    suggestWithPinyin(prefix) {
        const ptr0 = passStringToWasm0(prefix, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.searchengine_suggestWithPinyin(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    static withBm25Params(k1, b) {
        const ret = wasm.searchengine_withBm25Params(k1, b);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('searchlight_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
